        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
              Your final credit score is the sum of all weighted factors, ranging from 0 to 1000. Scores above 750 indicate excellent creditworthiness for medical loans and cashless treatment approvals.
            </p>
          </div>
        </div>
      </div>

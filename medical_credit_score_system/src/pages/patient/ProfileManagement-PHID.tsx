...
const ProfileManagement = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const updatedProfile = await PatientApiService.updateProfile(editData);
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-600">Please enter your PHID to access your profile.</p>
            <Button 

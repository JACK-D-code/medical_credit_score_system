        ...
        <div className="min-h-[70vh] flex flex-col items-center justify-center">
            <div className="glass-panel w-full max-w-md text-center py-12">
                ...
                <p className="text-gray-400 leading-relaxed px-4">
                    The Provider Registration portal has been temporarily disabled for planned infrastructure restructuring.
                </p>
                <div className="mt-8 p-4 bg-[rgba(255,255,255,0.03)] rounded-lg border border-white/5 mx-4">
                    <p className="text-sm font-medium text-emerald-400">Will be available soon</p>
                </div>
            </div>
        </div>
    );
